...
namespace Gameplay
{
    public class DebugHUD : MonoBehaviour
    {
        ...
        void OnGUI()
        {
            ...
            GUI.Label(new Rect(20, 35, 440, 40), "WASD: mover/strafe | flechas izq/der: girar | Espacio: interactuar | Tab: modo mapa\nM: usar Mapa | P: usar Perforador | N: usar Incienso | I: menú de pausa | T: dialogo DEMO (taberna de prueba)");
